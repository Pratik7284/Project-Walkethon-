  ...
  return (
    <section className="relative w-full min-h-[95vh] flex items-center justify-center pt-24 pb-16 bg-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-500 font-semibold mb-12 tracking-tight">
          Welcomes All Participants
        </p>

        {/* Powered By Section - Pill Style matching artwork */}
        <div className="flex flex-col items-center mb-16">
          <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.5em] mb-8">Powered By</p>
          <div className="flex flex-wrap items-center justify-center gap-6 md:gap-12">
            
            {/* HeartWise Pill + Label */}
            <div className="flex flex-col items-center gap-4">
              <div className="bg-white rounded-[40px] px-10 py-6 shadow-xl shadow-gray-100 border border-gray-50 flex items-center justify-center min-w-[240px] h-24 transition-transform hover:scale-105 duration-300">
                <img 
                  ...
                  onError={(e) => {
                    ...
                    e.currentTarget.parentElement!.innerHTML = `
                      <div class="flex items-center gap-2">
                        <span class="text-xl font-black text-slate-700 tracking-tighter">HEART WISE</span>
                        <div class="bg-[#E53935] w-8 h-8 rounded-full flex items-center justify-center text-white text-[10px] font-bold">@18</div>
                      </div>
                    `;
                  }}
                />
              </div>
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Main Sponsor</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              <div className="bg-white rounded-[40px] px-10 py-6 shadow-xl shadow-gray-100 border border-gray-50 flex items-center justify-center min-w-[240px] h-24 transition-transform hover:scale-105 duration-300">
                <img 
                  ...
                  onError={(e) => {
                    e.currentTarget.style.display = 'none';
                    e.currentTarget.parentElement!.innerHTML = `<span class="text-4xl font-black text-[#B22222] tracking-tight">Atorva</span>`;
                  }}
                />
              </div>
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em]">Healthcare Partner</span>
            </div>
        ...
        <button
          ...
          className="bg-gradient-to-r from-[#1FA6A8] to-[#198a8c] hover:scale-105 text-white px-14 py-5 rounded-full font-black text-xl transition-all shadow-2xl shadow-[#1FA6A8]/30 active:scale-95 mb-20"
        >
          Register For Walk
        </button>
